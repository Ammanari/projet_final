...
<body id="bodyNiveau3">
    ...
    <p class="rules2">C'est Partis!<br />
        ...
        Reorganisez les lettres : 2 45 78 54 23 12
    </p>

    <form id="form1" method="post" action="traitements.php">
        <label for="inputNiveau1"> </label>
        <br />
        <input id="inputNiveau1" type="text" name="niveau3" placeholder="Ecrivez votre reponse ici" />

        <br />
        <br />
        <input class="btn" id="submitbutton1" type="submit" name="Niveau3send" value="Send" />
    </form>
